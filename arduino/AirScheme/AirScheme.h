...
namespace GrowController
{
  ...
  public:
    ...
    {
      float targetTemp = (isDaytime ? tempSettings.day : tempSettings.night).target;
        ...
        airSettings_t humiditySettings)
    {
      ...
      Serial.println("humiditySettings.target: " + String(humiditySettings.target));
      Serial.println("humiditySettings.min: " + String(humiditySettings.min));
      Serial.println("humiditySettings.max: " + String(humiditySettings.max));
        ...
        VariableWattageFan *fan)
    {
      Serial.print("temp: ");
      Serial.println(temp);
      Serial.print("tempSettings.target: ");
      Serial.println(tempSettings.target);
